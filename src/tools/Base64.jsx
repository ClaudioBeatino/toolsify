...
export default function Base64() {
  ...
  const process = () => {
    ...
    try {
      ...
      setError('Input non valido per la decodifica Base64')
      setOutput('')
    }
  }
  ...
  return (
    <div className="space-y-4">
      ...
      <textarea
        ...
        placeholder={mode === 'encode' ? 'Testo da codificare...' : 'Testo Base64 da decodificare...'}
        className="w-full h-40 p-4 rounded-xl border border-gray-200 focus:border-indigo-400 focus:outline-none focus:ring-2 focus:ring-indigo-100 resize-y font-mono text-sm text-gray-800"
      />
